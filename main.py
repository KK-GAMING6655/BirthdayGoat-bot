...
# Placeholders for custom emojis (Stickers)

STICKER_1 = "<:Sticker1:1530846621401747607>"
STICKER_2 = "<:Sticker2:1530846757657772103>"
STICKER_3 = "<:Sticker3:1530846869767323688>"
STICKER_4 = "<:Sticker4:1530847016853307463>"
STICKER_5 = "<:Sticker5:1530847093793620070>"
...
async def set_ping(interaction: discord.Interaction, role: discord.Role):
    # Prevent @everyone and @here (which is the default guild role)
...
async def bday_test(interaction: discord.Interaction):
    ...
    # 2. Fetch config and send to channel
    ...
    # Test message uses the command sender as the "birthday person" for display purposes
